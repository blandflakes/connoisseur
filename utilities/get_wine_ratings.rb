...
def dump_notes(search_results)
  results_section = search_results.search("td.intro").search("div")
  # Get rid of "Recent Reviews" blurb
  results_section.shift
  # Get rid of copyright and footer crap
  results_section.pop
  # Get rid of timing of search
  results_section.pop

  results_section.each do |div|
    text = div.text.strip
